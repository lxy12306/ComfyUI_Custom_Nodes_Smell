...
NODE_CLASS_MAPPINGS = {**NODES_CLASS_NOVEL_PROMPT_POSITIVE, **NODES_CLASS_NOVEL_PROMPT_NAGATIVE, **NODES_CLASS_IMAGE_FUNCTION, **NODES_CLASS_ALPHA_CHANNEL, **NODES_CLASS_NOISE_INJECTION, **NODES_CLASS_CHECKPOINT}
NODE_DISPLAY_NAME_MAPPINGS = {**NODES_DISPLAY_NOVEL_PROMPT_POSITIVE, **NODES_DISPLAY_NOVEL_PROMPT_NAGATIVE, **NODES_DISPLAY_IMAGE_FUNCTION, **NODES_DISPLAY_ALPHA_CHANNEL, **NODES_DISPLAY_NOISE_INJECTION, **NODES_DISPLAY_CHECKPOINT}
