...
NODE_CLASS_MAPPINGS = {**NODES_CLASS_NOVEL_PROMPT_POSITIVE, **NODES_CLASS_NOVEL_PROMPT_NAGATIVE, **NODES_CLASS_IMAGE_FUNCTION}
NODE_DISPLAY_NAME_MAPPINGS = {**NODES_DISPLAY_NOVEL_PROMPT_POSITIVE, **NODES_DISPLAY_NOVEL_PROMPT_NAGATIVE, **NODES_DISPLAY_IMAGE_FUNCTION}
