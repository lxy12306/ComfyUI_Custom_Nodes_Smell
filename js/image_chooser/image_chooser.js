...
app.registerExtension({
    ...
    async nodeCreated(node) {
        if (node?.comfyClass === "ImageChooser" || node?.comfyClass === "Preview Chooser" || node?.comfyClass === "Preview Chooser Fabric"|| node?.comfyClass === "Simple Chooser") {
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeType?.comfyClass === "ImageChooser" || nodeType?.comfyClass==="Preview Chooser" || nodeType?.comfyClass==="Simple Chooser" || nodeType?.comfyClass === "Preview Chooser Fabric") {
            ...
            nodeType.prototype.imageClicked = function (imageIndex) {
                if (nodeType?.comfyClass==="ImageChooser" || nodeType?.comfyClass==="Preview Chooser" || nodeType?.comfyClass==="Simple Chooser") {
            ...
            nodeType.prototype.update = function() {
                ...
                if (this.send_button_widget) {
                    ...
                    } else if (FlowState.idle() && selection>0 && (nodeType?.comfyClass==="ImageChooser" || nodeType?.comfyClass === "Preview Chooser" || nodeType?.comfyClass === "Preview Chooser Fabric")) {
